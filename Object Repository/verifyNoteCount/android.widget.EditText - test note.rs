...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - test note</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'test note' or . = 'test note') and @resource-id = 'com.tce.studi:id/etNotes']</locator>
