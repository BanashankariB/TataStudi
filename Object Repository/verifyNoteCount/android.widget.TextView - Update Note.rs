...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Update Note</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Update Note' or . = 'Update Note') and @resource-id = 'com.tce.studi:id/tvCreateNote']</locator>
