...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Revise again</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Revise again' or . = 'Revise again') and @resource-id = 'com.tce.studi:id/tvLesson']</locator>
