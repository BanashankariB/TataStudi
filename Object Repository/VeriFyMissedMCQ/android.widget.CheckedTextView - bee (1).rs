...
<MobileElementEntity>
   ...
   <name>android.widget.CheckedTextView - bee (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.CheckedTextView' and (@text = 'bee' or . = 'bee') and @resource-id = 'android:id/text1']</locator>
