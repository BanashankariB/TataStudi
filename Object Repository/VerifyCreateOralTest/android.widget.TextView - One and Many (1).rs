...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - One and Many (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'One and Many' or . = 'One and Many') and @resource-id = 'com.tce.studi:id/tvLabel']</locator>
