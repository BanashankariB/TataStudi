...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - 3 Notes</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '3 Notes' or . = '3 Notes') and @resource-id = 'com.tce.studi:id/tvLessonDescription']</locator>
