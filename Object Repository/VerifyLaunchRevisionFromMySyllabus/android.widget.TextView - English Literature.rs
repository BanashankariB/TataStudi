...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - English Literature</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'English Literature' or . = 'English Literature') and @resource-id = 'com.tce.studi:id/tv_book_name']</locator>
