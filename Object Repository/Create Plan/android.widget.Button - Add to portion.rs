...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Add to portion</name>
   <tag></tag>
   <elementGuidId>e8078c13-122f-49dc-b233-f78ff4a663c5</elementGuidId>
   ...
   <locator>//*[@index = '3' and (contains(@text, 'Add to portion') or contains(., 'Add to portion'))]</locator>
