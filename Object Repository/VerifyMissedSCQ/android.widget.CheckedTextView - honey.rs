...
<MobileElementEntity>
   ...
   <name>android.widget.CheckedTextView - honey</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.CheckedTextView' and (@text = 'honey' or . = 'honey') and @resource-id = 'android:id/text1']</locator>
