...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Test again</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Test again' or . = 'Test again') and @resource-id = 'com.tce.studi:id/tvSecondaryAction']</locator>
