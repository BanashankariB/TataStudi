...
<MobileElementEntity>
   ...
   <name>android.widget.CheckedTextView - clothes</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.CheckedTextView' and (@text = 'clothes' or . = 'clothes') and @resource-id = 'android:id/text1']</locator>
