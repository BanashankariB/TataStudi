...
<MobileElementEntity>
   ...
   <name>android.widget.Image - search-black-icon</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'search-black-icon' or . = 'search-black-icon')]</locator>
