...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - English Language</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'English Language' or . = 'English Language') and @resource-id = 'com.tce.studi:id/tv_book_name']</locator>
