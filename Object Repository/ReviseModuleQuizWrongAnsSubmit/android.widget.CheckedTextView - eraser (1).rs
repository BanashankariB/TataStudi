...
<MobileElementEntity>
   ...
   <name>android.widget.CheckedTextView - eraser (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.CheckedTextView' and (@text = 'eraser' or . = 'eraser') and @resource-id = 'android:id/text1']</locator>
