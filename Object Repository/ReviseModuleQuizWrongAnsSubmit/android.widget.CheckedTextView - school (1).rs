...
<MobileElementEntity>
   ...
   <name>android.widget.CheckedTextView - school (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.CheckedTextView' and (@text = 'school' or . = 'school') and @resource-id = 'android:id/text1']</locator>
