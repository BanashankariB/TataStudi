...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - What have you revised</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'What have you revised:' or . = 'What have you revised:') and @resource-id = 'com.tce.studi:id/tvOverview']</locator>
