...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Try Again' or . = 'Try Again') and @resource-id = 'com.tce.studi:id/tvPrimaryAction']</locator>
