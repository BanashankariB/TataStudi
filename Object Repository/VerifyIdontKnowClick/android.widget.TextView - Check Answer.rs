...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Check Answer</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Check Answer' or . = 'Check Answer') and @resource-id = 'com.tce.studi:id/tvPrimaryAction']</locator>
