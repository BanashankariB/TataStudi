...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - I dont know</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = concat('I don' , &quot;'&quot; , 't know') or . = concat('I don' , &quot;'&quot; , 't know')) and @resource-id = 'com.tce.studi:id/tvSecondaryAction']</locator>
