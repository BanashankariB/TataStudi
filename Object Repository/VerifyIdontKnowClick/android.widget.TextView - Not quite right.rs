...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Not quite right</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Not quite right.' or . = 'Not quite right.')]</locator>
