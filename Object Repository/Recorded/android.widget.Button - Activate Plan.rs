...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Activate Plan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Activate Plan' or . = 'Activate Plan')]</locator>
