...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Add to portion (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Add to portion' or . = 'Add to portion')]</locator>
