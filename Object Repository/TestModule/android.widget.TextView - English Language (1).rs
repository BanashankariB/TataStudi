...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - English Language (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'English Language' or . = 'English Language')]</locator>
