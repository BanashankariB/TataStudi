...
Mobile.verifyElementVisible(findTestObject('PractiveQuiz/android.widget.CheckedTextView - tailor'), 0)

Mobile.verifyElementVisible(findTestObject('PractiveQuiz/android.widget.CheckedTextView - teacher'), 0)
